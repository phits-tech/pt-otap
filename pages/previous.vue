    ...
    <section class="section">
      <div class="container">
        ...
        <div class="columns">
          <div class="column">
            ...
            <div class="content is-size-5">
              ...
              <b-icon icon="image" /> <a :href="'/viewimg/viewimage4'">ภาพกิจกรรม</a>
              <br />
            </div>
          </div>
          <div class="column">
        ...
        <div class="columns">
          <div class="column">
            ...
            <div class="content is-size-5">
              ...
              <b-icon icon="image" /> <a :href="'/viewimg/viewimage3'">ภาพกิจกรรม</a>
              <br />
            </div>
          </div>
        </div>
        ...
        <div class="columns">
          <div class="column">
            ...
            <div class="content is-size-5">
              ...
              <b-icon icon="image" /> <a :href="'/viewimg/viewimage2'">ภาพกิจกรรม</a>
              <br />
            </div>
          </div>
        </div>
        ...
        <div class="columns mb-5">
          <div class="column">
            ...
            <div class="content is-size-5">
              ...
              <b-icon icon="image" /> <a :href="'/viewimg/viewimage1'">ภาพกิจกรรม</a>
              <br />
            </div>
          </div>
        </div>
        ...
        <div class="columns mb-5">
          <div class="column">
            <h1 class="title">
              Bootcamp 4: Exit Models / Intro to Market / Intro to Finance
            </h1>
            <div class="content is-size-5">
              <b-icon icon="calendar" /> 5-7 ธันวาคม 2565<br />
              <b-icon icon="clock" /> 08.00 - 17.00 <br />
              <b-icon icon="pin" /> โรงแรมแคนทารี ฮิลล์ จ.เชียงใหม่ <br />
            </div>
          </div>
          <div class="column">
            <div class="is-flex is-align-items-center mb-4">
        ...
        <div class="columns mb-5">
          <div class="column">
            <h1 class="title">
              Bootcamp 3: Technology Evaluation Canvas / UX and UI / Agile /
              Scrum
            </h1>
            <div class="content is-size-5">
              <b-icon icon="calendar" /> 18-20 พฤศจิกายน 2565<br />
              <b-icon icon="clock" /> 08.00 - 17.00 <br />
              <b-icon icon="pin" /> โรงแรมบรีซฮิลล์ จ.เพชรบูรณ์ <br />
            </div>
          </div>
          <div class="column">
            <div class="is-flex is-align-items-center mb-4">
            ...
            <div class="is-flex is-align-items-center mb-4">
              ...
              <div class="has-text-grey">
                ...
                [UX Designer] User Researcher <br />
                ODD-E THAILAND
              </div>
            </div>
            <div class="is-flex is-align-items-center mb-4">
              ...
              <div class="has-text-grey">
                ...
                นักวิเคราะห์ธุรกิจ (Business Analyst) <br />
                ODD-E THAILAND
              </div>
            </div>
          </div>
        ...
        <div class="columns mb-5">
          <div class="column">
            <h1 class="title">
              Bootcamp 2: Value Proposition / Business Model canvas
            </h1>
            <div class="content is-size-5">
          ...
          <div class="column">
            <div class="is-flex is-align-items-center mb-4">
              ...
              <div class="has-text-grey">
                ...
                Human-Centered / Consultant&Incubato
              </div>
            </div>
            <div class="is-flex is-align-items-center mb-4">
              <figure class="image is-48x48 is-inline-block mr-2">
              ...
              <div class="has-text-grey">
                ...
                HEALTH AND WELLNESS PROFESSIONALo
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="columns mb-5">
          <div class="column">
            <h1 class="title">Bootcamp 1: IP Strategy</h1>
            <div class="content is-size-5">
              <b-icon icon="calendar" /> 30 ตุลาคม 2565<br />
              <b-icon icon="clock" /> 08.00 - 17.00 <br />
              <b-icon icon="pin" /> ร้านสเต็กปีนัง จ.พิษณุโลก <br />
            </div>
          </div>
          <div class="column">
            <div class="is-flex is-align-items-center mb-4">
              ...
              <div class="has-text-grey">
                ...
                รองเลขาธิการ สวทน. และ CEO โครงการเมืองนวัตกรรมอาหาร (FOOD
                INNOPOLIS)
              </div>
            </div>
          </div>
        ...
        <div class="columns mb-5">
          <div class="column">
            <h1 class="title">PRE IGNITE PROGRAM</h1>
            <div class="content is-size-5">
              <b-icon icon="calendar" /> 29 กันยายน - 1 ตุลาคม 2565<br />
              <b-icon icon="clock" /> 08.00 - 16.00 <br />
              <b-icon icon="pin" /> ร้านอาหารต้นตาล จ.พิษณุโลก <br />
            </div>
          </div>
          <div class="column">
            <div class="is-flex is-align-items-center mb-4">
        ...
        <div class="columns">
          <div class="column">
            <h1 class="title">Bootcamp 4: Marketing การตลาด</h1>
            <div class="content is-size-5">
          ...
          <div class="column">
            ...
            <div class="is-flex is-align-items-center mb-4">
              ...
              <div class="has-text-grey">
                <span class="is-size-5"> ดร ปรเมษฐ์ ชุ่มยิ้ม </span><br />
                ที่ปรึกษาอาวุโส Food Innopolis<br />สำนักงานพัฒนาวิทยาศาสตร์และเทคโนโลยีแห่งชาติ
                (สวทช)
              </div>
            </div>
          </div>
          ...
          <div class="column">
            <div class="is-flex is-align-items-center mb-4">
              ...
              <div class="has-text-grey">
                ...
                Founder, <a href="https://uxacademy.in.th">UX Academy</a> and UX
                Thailand<br />
        ...
        <div class="columns mb-5">
          <div class="column">
            ...
            <div class="content is-size-5">
              ...
              <b-icon icon="clock" /> 9:00-17:00<br />
              <b-icon icon="pin" /> โรงแรม Grand Riverside
            </div>
          </div>
          <div class="column">
            <div class="is-flex is-align-items-center mb-4">
        ...
        <div class="columns mb-5">
          <div class="column">
            ...
            <div class="content is-size-5">
              ...
              <b-icon icon="clock" /> 9:00-17:00<br />
              <b-icon icon="pin" /> โรงแรมชินะปุระ
            </div>
          </div>
          <div class="column">
        ...
        <div class="columns mb-5">
          <div class="column">
            ...
            <div class="content is-size-5">
              ...
              <b-icon icon="clock" /> 9:00-14:00<br />
              <b-icon icon="pin" /> สเต็กปีนัง Penang Steak Brasserie<br />
            </div>
          </div>
          <div class="column">
            <div class="is-flex is-align-items-center mb-4">
